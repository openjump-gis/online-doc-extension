 ...
 *        snapshot rev.5522
 */
public class OpenWebDocumentationPlugIn extends AbstractOpenWebSitePlugIn {
    ...
    /** Plugin name */
    public final static String NAME = DesktopUtils.Documentation;

    @Override
    public URL getURL() throws MalformedURLException {

        String url = "http://ojwiki.soldin.de/index.php?title=Documentation";
