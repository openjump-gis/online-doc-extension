 ...
 *        snapshot rev.5522
 */
public class OpenWebOnlineManualPlugIn extends AbstractOpenWebSitePlugIn {
    ...
    /** Plugin name */
    public final static String NAME = DesktopUtils.OnlineManual;

    @Override
    public URL getURL() throws MalformedURLException {

        String url = "http://ojwiki.soldin.de/index.php?title=Index";
