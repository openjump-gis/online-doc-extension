 ...
 *        snapshot rev.5522
 */
public class OpenWebTranslatePlugIn extends AbstractOpenWebSitePlugIn {
    ...
    /** Plugin name */
    public final static String NAME = DesktopUtils.Translate;

    @Override
    public URL getURL() throws MalformedURLException {

        String url = "http://ojwiki.soldin.de/index.php?title=How_to_translate_OpenJUMP_into_another_language";
