 ...
 *        snapshot rev.5522
 */
public class OpenWebWikiPlugIn extends AbstractOpenWebSitePlugIn {
    ...
    /** Plugin name */
    public final static String NAME = DesktopUtils.Wiki;

    @Override
    public URL getURL() throws MalformedURLException {

        String url = "http://ojwiki.soldin.de/index.php?title=Main_Page";
